...
@ScriptManifest(name = "SkrrtMiniQuester", authors = {"SkrrtNick"}, category = "Quests")
public class SkrrtMiniQuester extends Script implements Painting, MessageListening07, Arguments {
...
//            TaskSet tasks = new TaskSet(new Test());
